  ...
  return (
    <footer className="border-t border-zinc-200/60 py-10 dark:border-zinc-800/60">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-6 px-6">
        {/* SNS row — always centered, sits above the nav */}
        <div className="flex flex-col items-center gap-3">
          <p className="text-xs tracking-wide text-zinc-400 uppercase">{t('sns.heading')}</p>
          <SnsIcons />
        </div>

        {/* Copyright + nav row */}
        <div className="flex w-full flex-col items-center gap-3 text-xs text-zinc-500 sm:flex-row sm:justify-between">
